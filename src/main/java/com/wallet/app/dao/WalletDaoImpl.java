...
public class WalletDaoImpl implements WalletDao {
    ...
    public Wallet getWalletById(Integer walletId) throws WalletException, WalletRepositoryException {
        if (!this.wallets.containsKey(walletId))
            throw new WalletRepositoryException("Wallet does not exist");
